<template>
  <div class="page-home">
    ...
    <div class="options-box mgb_40">
      <label class="check-box fvertical mgb_20" for="layout-logo"
        @change="layoutInfo.showSidebarLogo = !layoutInfo.showSidebarLogo">
        <input type="checkbox" id="layout-logo" :checked="layoutInfo.showSidebarLogo" />
        显示侧边栏logo
      </label>
      <label class="check-box fvertical mgb_20" for="layout-tags"
        @change="layoutInfo.showTagsView = !layoutInfo.showTagsView">
        <input type="checkbox" id="layout-tags" :checked="layoutInfo.showTagsView" />
        显示历史记录标签
      </label>
      <label class="check-box fvertical mgb_20" for="layout-open"
        @change="layoutInfo.sidebarOpen = !layoutInfo.sidebarOpen">
    ...
    <div class="form-item fvertical">
      ...
      <input class="the-input" type="text" v-model="styleVariable.sidebarWidth"
        @input="e => onInput(e, 'sidebarWidth')">
    </div>
    <div class="form-item fvertical">
    ...
    <div class="form-item fvertical">
      ...
      <input class="the-input" type="text" v-model="styleVariable.menuFontSize"
        @input="e => onInput(e, 'menuFontSize')">
    </div>
    <div class="form-item fvertical">
      <span class="form-label">菜单标题高度（px）</span>
      <input class="the-input" type="text" v-model="styleVariable.menuTitleHeight"
        @input="e => onInput(e, 'menuTitleHeight')">
    </div>
    <div class="form-item fvertical">
      <span class="form-label">菜单栏目高度（px）</span>
      <input class="the-input" type="text" v-model="styleVariable.menuItemHeight"
        @input="e => onInput(e, 'menuItemHeight')">
    </div>
    <div class="form-item fvertical">
    ...
    <div class="form-item fvertical">
      ...
      <input class="the-input" type="text" v-model="styleVariable.navbarHeight"
        @input="e => onInput(e, 'navbarHeight')">
    </div>
    <div class="form-item fvertical">
      <span class="form-label">主容器内边距（px）</span>
      <input class="the-input" type="text" v-model="styleVariable.contentPadding"
        @input="e => onInput(e, 'contentPadding')">
    </div>
    <div class="form-item fvertical">
