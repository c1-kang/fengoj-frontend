...
import type { QuestionQuerySubmitRequest } from '../models/QuestionQuerySubmitRequest';
...
export class QuestionControllerService {
    ...
    public static listQuestionSubmitByPageUsingPost(
        questionQuerySubmitRequest: QuestionQuerySubmitRequest,
    ): CancelablePromise<BaseResponse_Page_QuestionSubmitVO_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/question_submit/list/page',
            body: questionQuerySubmitRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
     ...
     * @returns BaseResponse_QuestionSubmitTestResponse_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static testJudgeUsingPost(
        questionSubmitTestRequest: QuestionSubmitTestRequest,
    ): CancelablePromise<BaseResponse_QuestionSubmitTestResponse_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
